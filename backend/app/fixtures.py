...
_GROUP_RAW: list[tuple[str, str, str, str, str, str]] = [
    ...
    ("E", "ECU", "GER", "2026-06-25", "19:00", "MetLife Stadium, Nueva Jersey"),
    ("E", "CUW", "CIV", "2026-06-25", "19:00", "Lincoln Financial Field, Philadelphia"),
    ...
    ("L", "CRO", "GHA", "2026-06-27", "17:00", "Lincoln Financial Field, Philadelphia"),
    ("L", "PAN", "ENG", "2026-06-27", "17:00", "MetLife Stadium, Nueva Jersey"),
    ("K", "POR", "COL", "2026-06-27", "20:00", "Hard Rock Stadium, Miami"),
    ("K", "COD", "UZB", "2026-06-27", "20:00", "Mercedes-Benz Stadium, Atlanta"),
